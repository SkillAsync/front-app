            ...
            <div class="flex items-center space-x-6 text-lg font-semibold tracking-tight px-2">
                ...
                <div class="relative" v-if="token">
                    <button id="dropdownAvatarNameButton" @click="toggleDropdown"
                        ...
                        <img class="w-8 h-8 me-2 rounded-full" :src="user.value.avatar ? user.value.avatar : 'https://cdn-icons-png.flaticon.com/512/149/149071.png'" alt="avatar">
                        
                        {{ user.value.first_name.charAt(0).toUpperCase() + user.value.last_name}}
                    ...
                    <div v-show="dropdownVisible" id="dropdownAvatarName"
                        ...
                        <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div class="truncate">{{ user.value.email }}</div>
                        </div>
