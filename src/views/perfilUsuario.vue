                ...
                <div class="">
                    ...
                    <form @submit.prevent="updateProfile">
                        <div
                            ...
                            <!-- Profile Image -->
                            <div class="mx-auto flex justify-center w-[141px] h-[141px] bg-blue-300/20 rounded-full"
                                :style="{ backgroundImage: 'url()', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }">
                        ...
                        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                            <div class="w-full  mb-4 mt-6">
                                ...
                                <input type="text"
                                    ...
                                    :placeholder="user.first_name" v-model="name">
                            </div>
                            <div class="w-full  mb-4 lg:mt-6">
                                <label for="" class=" dark:text-gray-300">Apellidos</label>
                                <input type="text"
                                    class="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                                    :placeholder="user.last_name" v-model="lastname">
                            </div>
                        </div>
                        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                            <div class="w-full  mb-4 mt-6">
                            ...
                            <div class="w-full  mb-4 lg:mt-6">
                                ...
                                <input type="text"
                                    class="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                                    :placeholder="user.phone" v-model="phone">
                            </div>
                        </div>
                        ...
                        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                            <div class="w-full  mb-4 mt-6">
                                ...
                                <input type="text"
                                    class="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                                    :placeholder="user.city" v-model="city">
                            </div>
                            <div class="w-full  mb-4 lg:mt-6">
                                <label for="" class=" dark:text-gray-300">Biografia</label>
                                <input type="text"
                                    class="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                                    :placeholder="user.bio" v-model="bio">
                            </div>
                        </div>
                        ...
                        <div class="w-full rounded-lg bg-green-700 mt-4 text-white text-lg font-semibold">
                            <button type="submit" class="w-full p-4" @click="updateProfile">Actualizar
                                Perfil</button>
                        </div>
                    </form>
                </div>
