            ...
            <div class="">
                ...
                <form>
                    ...
                    <div
                        ...
                        <!-- Profile Image -->
                        <div
                            class="mx-auto flex justify-center w-[141px] h-[141px] bg-blue-300/20 rounded-full" :style="{ backgroundImage: 'url(' + user.value.avatar + ')', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }"
>
